...
//NEW HASHING STRATEGIES (2)
//TODO1:
struct irregular_hashing : public hashing_strategy{
    int operator()(char * str, int N) override;
};
//TODO2:
struct regular_hashing : public hashing_strategy{
    int operator()(char * str, int N) override;
};
...
//NEW COLLISION STRATEGIES (2)
//TODO3: quadratic_probing 
